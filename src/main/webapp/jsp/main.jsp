    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a>欢迎:${sessionScope.adm.username}</a></li>
                ...
                <div class="panel panel-success">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li>
                                    <a href="javascript:$('#centerLay').load('../goeasy1.jsp')">进入聊天室</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="../img/一宝6.jpg" alt="First slide">
                            <div class="carousel-caption">一宝6</div>
                        </div>
                        <div class="item">
                            <img src="../img/一宝2.jpg" alt="Second slide">
                            <div class="carousel-caption">一宝2</div>
                        </div>
                        <div class="item">
                            <img src="../img/一宝3.jpg" alt="Third slide">
                            <div class="carousel-caption">一宝3</div>
                        </div>
                    </div>
                    <!-- 轮播（Carousel）导航 -->
